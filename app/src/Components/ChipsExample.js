...
function ChipsExample() {
    const [chipData, setChipData] = useState([
        {key: 0, label: "Angular", color: "yellow", icon: <AnalyticsOutlined />},
        {key: 1, label: "React", color: "yellow", icon: <EmailOutlined />},
        {key: 2, label: "Wordpress", color: "yellow", icon: <FaceTwoTone />},
        {key: 3, label: "PHP", color: "yellow", icon: <PhoneAndroid />},
        {key: 4, label: "Java", color: "yellow", icon: <Javascript />},
